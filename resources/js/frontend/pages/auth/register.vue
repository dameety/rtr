                                ...
                                <form @submit.prevent="authenticate()">
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input class="form-control" name="name" v-model="form_data.name" placeholder="name" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <b-form-select v-model="form_data.role" name="roles" :options="roles"></b-form-select>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        ...
        created() {
            Object.keys(this.$restaurant.user_roles).map(role => {
                this.roles.push({
                    text: role.toLowerCase(),
                    value: this.$restaurant.user_roles[role]
                });
            });
        },
        ...
        methods: {
            ...
            authenticate () {
                ...
                this.$store
                    .dispatch(types.REGISTER_REQUEST, this.form_data)
                    .then(() => {
